...
%>
       ...
       <div class="navbar-header">
         ...
         <a class="navbar-brand" href="<%= request.getContextPath() %>/"><img height="25" src="https://mintbook.com/assetsNew/img/animated5.gif" alt="DSpace logo" /></a>
       </div>
...
<li><a href="/jspui/browse?type=subject">Category</a></li>
...
<li/>
 ...
 %>
	...
	<% } %>             
             ...
             <li><a href="/jspui/mydspace">My Digital Library</a></li>
	...
	<form method="get" action="<%= request.getContextPath() %>/simple-search" class="navbar-form navbar-right">
	    <div class="form-group">
          <input type="text" class="form-control" placeholder="<fmt:message key="Search Digital Library"/>" name="query" id="tequery" size="25"/>
        </div>
